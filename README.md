...
Configuration
Environment Setup# Copy environment template cp .env.example .env cp backend/.env.example backend/.env

Configure Environment Variables# Camp Network Configuration CAMP_NETWORK_RPC_URL= PRIVATE_KEY=

Origin SDK Configuration
ORIGIN_SDK_API_KEY=

IPFS Configuration
IPFS_API_URL= IPFS_API_KEY=

Application Configuration
JWT_SECRET= DATABASE_URL=

Deploy Smart Contractsnpx hardhat compile npx hardhat run scripts/deploy.js --network campTestnet
