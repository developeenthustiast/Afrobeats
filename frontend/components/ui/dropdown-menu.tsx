...
/**
 * Dropdown Menu Component - WCAG 2.2 AA Compliant
 * 
...
>(({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
        ...
        className={cn(
            ...
            "min-h-[2.5rem]", // 40px (WCAG 2.2)
            "focus:bg-indigo-600/20 data-[state=open]:bg-indigo-600/20",
            inset && "pl-8",
            className
        )}
        {...props}
...
>(({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.SubContent
        ref={ref}
        className={cn(
            "z-50 min-w-[8rem] overflow-hidden rounded-lg border border-slate-700 bg-slate-900 p-1 text-slate-100 shadow-xl",
...
>(({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
        ...
        className={cn(
            ...
            "min-h-[2.5rem]", // 40px (WCAG 2.2)
            "focus:bg-indigo-600/20 focus:text-indigo-300",
